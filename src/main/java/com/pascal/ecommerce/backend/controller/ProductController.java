...
public class ProductController {
    ...
    @GetMapping("/product/by-price-range")
    public ResponseEntity<ApiResponse> findProductByPriceRange(@RequestParam BigDecimal minPrice, @RequestParam BigDecimal maxPrice) {
        try {
